/**
 * Unified MediaPicker Component
 * Consolidated media selection modal with advanced features
 */
...
export default function MediaPicker({
  ...
  const fetchMedia = useCallback(async () => {
    ...
    try {
      ...
      if (allowedTypes.length > 0) {
        const mimeTypes = allowedTypes.map(type => {
          switch (type) {
  ...
  }, [pagination.page, pagination.limit, search, currentFolder, allowedTypes])
