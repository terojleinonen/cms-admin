...
import { Dialog, DialogPanel, DialogTitle, Transition } from '../ui/CustomModal'
import { Fragment } from 'react'
import { XMarkIcon, EyeIcon, EyeSlashIcon } from '../ui/Icons'
...
export default function UserModal({ user, onClose, onSuccess }: UserModalProps) {
  ...
  return (
    <Dialog isOpen={true} onClose={onClose} className="relative z-50">
