...
import { POST as uploadMedia, GET as getMediaList } from '@/api/media/route'
import { GET as getMedia, PUT as updateMedia, DELETE as deleteMedia } from '@/api/media/[id]/route'
